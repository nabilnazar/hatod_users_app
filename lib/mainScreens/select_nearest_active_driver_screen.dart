...
class _SelectNearestActiveDriversScreenState extends State<SelectNearestActiveDriversScreen>
{
  ...
  getFareAmountAccordingToVehicleType(int index)
  {
    if(tripDirectionDetailsInfo != null)
    {
      ...
      if(dList[index]["car_details"]["type"].toString() == "hatod-x") //means executive type of car - more comfortable pro level
          {
        fareAmount = (AssistantMethods.calculateFareAmountFromOriginToDestination(tripDirectionDetailsInfo!) * 2).toStringAsFixed(1);
      }
      if(dList[index]["car_details"]["type"].toString() == "hatod-go") // non - executive car - comfortable
          {
        ...
        itemBuilder: (BuildContext context, int index)
        {
          return GestureDetector(
            ...
            child: Card(
              ...
              elevation: 3,
              shadowColor: const Color(0xff00579a),
