...
import 'package:hatod_users_app/mainScreens/search_places_screen.dart';
import 'package:hatod_users_app/mainScreens/select_nearest_active_driver_screen.dart';
import 'package:hatod_users_app/widgets/pay_fare_amount_dialog.dart';
import 'package:hatod_users_app/widgets/rate_driver_screen.dart';
  ...
  retrieveOnlineDriversInformation(List onlineNearestDriversList) async
  {
    ...
    for(int i=0; i<onlineNearestDriversList.length; i++)
    {
          ...
          .then((dataSnapshot)
      {
        ...
        print("this is online driver information:"+dList.toString());
      });
    }
  }
                          ...
                          children: [
                            ...
                            Column(
                              ...
                              children:[
                                const Text(
                                  "To:",
                                  style: TextStyle(color: Color(0xFF053BB3), fontSize: 12),
                                ),
                                Text(
                                  Provider.of<AppInfo>(context).userDropOffLocation != null
                                    ? Provider.of<AppInfo>(context).userDropOffLocation!.locationName!
                                    : "Where to go?",
                                  style: const TextStyle(color: Color(0xFF053BB3), fontSize: 14),
                                ),
                              ],
                            ),
                          ],
